...
from segar.tasks.puttputt import puttputt_default_config, invisiball_config
...
def test(task=None, visual_dist="baseline", iterations=100):
    ...
    visual_config = get_env_config("visual", _VIS_GEN, dist_name=visual_dist)
