...
def create_initialization():
    ...
    config = dict(
        ...
        priors=[
            ...
            Prior(Size, GaussianNoise(0.3, 0.01, clip=(0.1, 0.3)),
                  entity_type=Object),
...
def make_data_loaders(factors: list[Type[Factor]], batch_size: int = 64,
    ...
    train_dataset = create_iid_from_init(initialization, input_observation,
                                         target_observation,
                                         n_observations=1000)
    test_dataset = create_iid_from_init(initialization, input_observation,
                                        target_observation,
                                        n_observations=1000)
