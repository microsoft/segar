...
class Generator:
    _factors = (Heat, Friction, Charge, Magnetism, Density, StoredEnergy,
                Mass, Alive)

    def __init__(self, dim_x: int, dim_y: int, n_factors: int,
                 stride: int = 1, grayscale: bool = False,
                 n_rand_factors: int = 3, model_path: Optional[str] = None):
    ...
    def get_rendering_dims(self, dim_x: Optional[int] = None,
                           dim_y: Optional[int] = None) -> tuple[int, int]:
