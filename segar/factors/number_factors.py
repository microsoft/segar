...
class NumericFactor(Factor[T], default=0):
    _protected_in_place = ('set', '__iadd__', '__imul__', '__isub__',
                           '__idiv__')
    ...
    def __add__(self, other: Union[NumericFactor, T]
    ...
    def __mul__(self, other: Union[NumericFactor, T]
                ) -> Union[NumericFactor, T]:
        val = self.value * Factor._get_value(other)
        if isinstance(other, self.__class__):
            return self.__class__(val)
    ...
    def __rmul__(self, other: Union[NumericFactor, T]
                 ) -> Union[NumericFactor, T]:
        val = self.value * Factor._get_value(other)
        if isinstance(other, self.__class__):
            return self.__class__(val)
    ...
    def __sub__(self, other: Union[NumericFactor, T]
                ) -> Union[NumericFactor, T]:
        val = self.value - Factor._get_value(other)
        if isinstance(other, self.__class__):
            return self.__class__(val)
    ...
    def __truediv__(self, other: Union[NumericFactor, T]
                    ) -> Union[NumericFactor, T]:
        val = self.value / Factor._get_value(other)
        if isinstance(other, self.__class__):
            return self.__class__(val)
    ...
    def __rtruediv__(self, other: Union[NumericFactor, T]
                     ) -> Union[NumericFactor, T]:
...
class Charge(NumericFactor[float], default=0.):
    pass


class Magnetism(NumericFactor[float], default=0.):
    pass


class StoredEnergy(NumericFactor[float], default=0.):
    pass


class Heat(NumericFactor[float], default=0.):
    pass


class Friction(NumericFactor[float], default=0.):
    pass
