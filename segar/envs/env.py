...
if __name__ == "__main__":
    ...
    env1 = SEGAREnv("emptyx0-hard-rgb", num_envs=2, num_levels=5, framestack=1, resolution=64, max_steps=200, seed=123)
    env2 = SEGAREnv("emptyx0-hard-rgb", num_envs=1, num_levels=5, framestack=1, resolution=64, max_steps=200, seed=456)
    print("")
